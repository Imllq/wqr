...
if ~exist('D:\研究生作业\数模作业2\FTCS','dir')
    mkdir('D:\研究生作业\数模作业2\FTCS')
end

% 动图参数
Fname='D:\研究生作业\数模作业2\FTCS\';
GifName='FTCS.gif';
delay=0.3;  % 延迟时间
...
if ~exist('D:\研究生作业\数模作业2\JX','dir')
    mkdir('D:\研究生作业\数模作业2\JX')
end

% 动图参数
Fname='D:\研究生作业\数模作业2\JX\';
GifName='JieXi.gif';
delay=0.3;  % 延迟时间
