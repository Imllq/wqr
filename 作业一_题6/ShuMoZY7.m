...
if ~exist('D:\研究生作业\数模作业7\迎风','dir')
    mkdir('D:\研究生作业\数模作业7\迎风')
end

Fname='D:\研究生作业\数模作业7\迎风\';
GifName='FTCS.gif';
delay=0.3;  % 延迟时间
...
while count<3000
    count=count+1;
    T1(xi)=(1-lambda)*T0(xi)+lambda*T1(xi-1);
  
    % 边界条件
    T1(1)=(1-lambda)*T0(1)+lambda*T1(end);
...
if ~exist('D:\研究生作业\数模作业7\蛙跃','dir')
    mkdir('D:\研究生作业\数模作业7\蛙跃')
end

Fname='D:\研究生作业\数模作业7\蛙跃\';
GifName='CTCS.gif';
delay=0.3;  % 延迟时间
...
if ~exist('D:\研究生作业\数模作业7\迎风大','dir')
    mkdir('D:\研究生作业\数模作业7\迎风大')
end

Fname='D:\研究生作业\数模作业7\迎风大\';
GifName='FTCS.gif';
delay=0.3;  % 延迟时间
...
if ~exist('D:\研究生作业\数模作业7\蛙跃大','dir')
    mkdir('D:\研究生作业\数模作业7\蛙跃大')
end

Fname='D:\研究生作业\数模作业7\蛙跃大\';
GifName='CTCS.gif';
delay=0.3;  % 延迟时间
